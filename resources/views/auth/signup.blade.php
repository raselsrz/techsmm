        ...
        <div class="card card_v2 mb-5">
          <div class="card-body">
            ...
            <form  action="#">
              ...
              <input type="hidden" name="_csrf" value="ijns69ZW_h3n3G1opXVRFRS_NbpsvBNxlQV77xOSldfyfdyF527JR7iyLhntMWVnR8Vx8D7jKxD4PRq2af7Nog==">
              <button type="submit" class="btn btn-primary btn-gradient w-100">Sign up</button>
            </form>
            <p class="text-center">
              Already have an account? <a href=" {{ route('signins') }}">Sign in</a>
            </p>
