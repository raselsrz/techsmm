...
<script type="text/javascript" src="{{ asset('js/edzzxisio49akyza.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/s27n4hab0gaatrhm.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/yleebc6f5ow479ct.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/0e7qiaj8kmea5mhk.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/farxtjet462wr6bi.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/5rlpuzscp8ism29e.js') }}"></script>
...
<script type="text/javascript" >
  window.modules.layouts = {"theme_id":2,"auth":0,"live":true,"csrftoken":"A0Xmx9LZyp3_EQZ5_FphWn1lSkIqYwRT7ndW1Z8kQyxmaLevoqGJ0I9zRzyTFiwZOToBcmAaQQOKJzyC1WUKTg=="};
</script>
<script type="text/javascript" >
